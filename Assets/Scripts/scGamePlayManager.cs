...
public class scGamePlayManager : MonoBehaviour {
    public static scGamePlayManager instance;

    public GameObject Player;
    public List<GameObject> PlayerForts;
    public List<GameObject> EnemyForts;
    public GameObject RunTimeGameObjects;
